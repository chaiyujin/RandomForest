...
namespace Yuki {
	...
	CriterionMSE::CriterionMSE(DataSet& data, const Param &param, double all_samples_weight)
	...
	std::pair<double, double> CriterionMSE::children_impurity() {
	...
	void CriterionMSE::update(int new_pos) {
	...
	double CriterionMSE::impurity_improvement() {
		double imp = impurity();
